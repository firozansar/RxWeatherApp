package info.firozansari.weatherapp.data

import org.parceler.Parcel
import org.parceler.ParcelConstructor

@Parcel(Parcel.Serialization.BEAN)
data class HourlyWeatherDTO @ParcelConstructor constructor(
    val timestamp: Long,
...
@Parcel(Parcel.Serialization.BEAN)
data class WeeklyWeatherDTO @ParcelConstructor constructor(
    val maxTemp: String,
    val minTemp: String,
